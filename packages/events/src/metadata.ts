 ...
 * a type error.
 */
export const EVENT_METADATA: Record<DomainEvent["type"], { tier: 1 | 2 | 3; description: string }> =
  {
    ...
    "machine.reconciled": {
      tier: 2,
      description:
        "Reconciliation removed undeclared software or settings to close a gap with desired state.",
    },
    "machine.first_seen": {
      tier: 1,
